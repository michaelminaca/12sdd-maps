                  ...
                  value: function (t) {
                    ...
                    if (x(t) || w(t)) {
                        ...
                        if (void 0 !== n && _(n)) {
                          ...
                          var o = g(i) ? i.startTime + i.duration : b(i),
                            ...
                            p = d(n)
                              ...
                              : h(a, e, this._currenTime);
                          this._automationEvents.push(p);
                        }
                        void 0 !== i &&
                          C(i) &&
                          this._automationEvents.push(u(this.getValue(e), e)),
                          void 0 !== i &&
                            g(i) &&
                      ...
                      var y = d(t)
                        ...
                        : f(t)
                        ? h(t.value, e, this._currenTime)
                        : t;
                      if (-1 === m) this._automationEvents.push(y);
                      else {
                        if (
                          g(t) &&
                          e + t.duration > b(this._automationEvents[m])
                        )
                          return !1;
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    if (
                      void 0 !== i &&
                      g(i) &&
                      (void 0 === n || !_(n) || i.startTime + i.duration > t)
                    )
    ...
    function (t, e, s) {
      ...
      const a = new WeakSet(),
        ...
        ht = (t, e, s, n) => {
          const { activeInputs: i, passiveInputs: o } = z(e),
            ...
            c = (r) => {
              ...
              if (r) {
                ...
                const e = ((t, e, s) => T(t, (t) => t[0] === e && t[1] === s))(
                  i,
                  t,
                  s
                );
          ...
          return (
            !!Z(r, [e, s], (t) => t[0] === e && t[1] === s, !0) &&
            (a.add(c), P(t) ? X(i, t, [s, c], !0) : Y(o, [t, s, c], !0), !0)
          );
        },
        ut = (t, e, s, n, i) => {
          const [o, r] = ((t, e, s, n) => {
          ...
          if (
            (null !== o &&
              (K(t, o), !r || e || it(t) || et(st(t), st(s), n, i)),
            P(s))
          ) {
        ...
        lt = (t, e, s, n) => {
          ...
          null !== i &&
            (K(t, i), !o || e || it(t) || st(t).disconnect(nt(s), n));
        };
      class pt {
        constructor(t) {
          this._map = new Map(t);
            ...
            try {
              ...
              return s instanceof Promise
                ? (we.set(t, s),
                  s
                    .catch(() => !1)
                    .then((e) => (we.delete(t), be.set(t, e), e)))
                : (be.set(t, s), s);
            } catch {
              return be.set(t, !1), !1;
            }
      ...
      const Te = 'undefined' == typeof window ? null : window,
        Se =
          ...
          (t, e) => {
            ...
            if ((It(s, e), !(e.maxDecibels > e.minDecibels))) throw Ce();
            return (
              Ft(s, e, 'fftSize'),
              Ft(s, e, 'maxDecibels'),
              Ft(s, e, 'minDecibels'),
              ...
              render(e, s, n) {
                ...
                return void 0 !== i
                  ...
                  : (async (e, s, n) => {
                      ...
                      return t.set(s, i), await qe(e, s, i, n), i;
                    })(e, s, n);
              },
            };
          });
      ...
      const Ve = ((t) =>
          null === t
            ...
            : null)(Te),
        Ne = ((Pe = Ve), (t) => null !== Pe && t instanceof Pe);
      var Pe;
      ...
      const Be = ((t) =>
          null === t
            ...
            : null)(Te),
        We = ((Ge = Be), (t) => null !== Ge && t instanceof Ge);
      var Ge;
      const Ue = (
          (t) => (e) =>
            null !== t &&
        ...
        Ze = ((t, e, s, n, i, o, r, a, c, u, l, p, f, _, m) =>
          class extends u {
            constructor(e, n, i, o) {
              ...
              if (void 0 === t)
                n = ((t, e) => {
                  ...
                  for (const i of s.outputs)
                    Q(i) ? ut(t, e, ...i) : lt(t, e, ...i), n.push(i[0]);
          ...
          })(fe, me, $, ge, et, L, ye, k, st, Z, P, it, ot),
          xe,
          ((t, e, s, n, i, o) => (r) => (a, c) => {
            const h = t.get(a);
            if (void 0 === h) {
      ...
      const Ye = ((t, e, s, n, i, o) =>
        ...
        $e = ((t) =>
          null === t
            ...
            ? t.AudioBuffer
            : null)(Te),
        Je = ((Ke = new Uint32Array(1)), (t) => ((Ke[0] = t), Ke[0]));
      var Ke;
      const ts = ((t, e) => (s) => {
        ...
        ss = ((t, e, s, n, i, o, r, a) => {
          ...
          return class h {
            constructor(h) {
              ...
              const d =
                null !== n && e(o, o)
                  ? new n({ length: u, numberOfChannels: l, sampleRate: p })
      ...
      var hs;
      const us = ((t, e) => (s, n, i, o) => (t(n).replay(i), e(n, s, i, o)))(
          ((t) => (e) => {
            const s = t(e);
            if (null === s.renderer)
              throw new Error(
              ...
              return void 0 !== l
                ...
                : (async (c, h, u) => {
                    ...
                    return (
                      o.set(h, l),
                      p
                        ? await t(h, c.playbackRate, l.playbackRate, u)
                        : await n(h, c.playbackRate, l.playbackRate, u),
                      await i(c, h, l, u),
                      l
                    );
                  })(c, h, u);
        ...
        ps = (
          ...
          (f, _, m, g = null, v = null) => {
              ...
              w = {
                ...
                cancelAndHoldAtTime(t) {
                  if ('function' == typeof m.cancelAndHoldAtTime)
                    ...
                    null === x && y.flush(f.context.currentTime), y.add(i(t));
                    const s = Array.from(y).pop();
                    m.cancelScheduledValues(t),
                      e !== s &&
                        void 0 !== s &&
                        ('exponentialRampToValue' === s.type
                          ? m.exponentialRampToValueAtTime(s.value, s.endTime)
                          : 'linearRampToValue' === s.type
                          ? m.linearRampToValueAtTime(s.value, s.endTime)
                          : 'setValue' === s.type
                          ? m.setValueAtTime(s.value, s.startTime)
                ...
                setValueCurveAtTime(t, e, s) {
                  ...
                  if (null !== p && 'webkitAudioContext' === p.name) {
                    ...
                    const h = r / i;
                    h < t && d(w, c[c.length - 1], h), d(w, n[n.length - 1], t);
                  } else
                    null === x && y.flush(f.context.currentTime),
                      y.add(l(n, e, s)),
            ...
            return s.set(w, m), e.set(w, f), t(w, x), w;
          }
        )(
          ((ds = u),
          (t, e) => {
          ...
          class extends ys {
            ...
            getFrequencyResponse(t, e, s) {
              try {
                ...
                if (11 === t.code) throw bs();
                throw t;
              }
              if (t.length !== e.length || e.length !== s.length) throw bs();
            }
          });
      ...
      const Es = ((t, e) => (s, n) => {
                ...
                return void 0 !== l
                  ...
                  : (async (c, h, u) => {
                      ...
                      return (
                        o.set(h, l),
                        p
                          ? await t(h, c.offset, l.offset, u)
                          : await n(h, c.offset, l.offset, u),
                        await i(c, h, l, u),
                        l
                      );
                    })(c, h, u);
                ...
                return void 0 !== u
                  ...
                  : (async (a, c, h) => {
                      ...
                      return (
                        r.set(c, u),
                        l
                          ? await t(c, a.delayTime, u.delayTime, h)
                          : await n(c, a.delayTime, u.delayTime, h),
                        await i(a, c, u, h),
                        u
                      );
                    })(a, c, h);
        ...
        Ls =
          ...
          (t, e) => {
            ...
            if ((It(s, e), e.channelCount > 2)) throw zs();
            ...
            if (
              ...
              if (null === c) {
                ...
                c = (async () => {
                  ...
                  return ((t, e, s, n) => {
                    const i =
                        s instanceof Float64Array ? s : new Float64Array(s),
      ...
      const Xs = ((t, e, s, n, i, o) =>
          ...
          ((Zs = Gs),
          (t, e, s) => {
            if (void 0 === t.createIIRFilter) return Zs(t, e, s);
                ...
                return void 0 !== p
                  ...
                  : (async (h, u, l) => {
                      ...
                      return (
                        o.set(u, p),
                        d
                          ? (await t(u, h.detune, p.detune, l),
                            await t(u, h.frequency, p.frequency, l))
                          : (await n(u, h.detune, p.detune, l),
      ...
      const sn = (
          ...
          (o, { curve: r, oversample: a, ...c }) => {
            ...
            null !== r &&
              (v.curve = r instanceof Float32Array ? r : new Float32Array(r)),
      ...
      const cn = ((t, e, s, n, i, o, r) =>
                ...
                return void 0 !== h
                  ...
                  : (async (r, a, c) => {
                      ...
                      return (
                        o.set(a, h),
                        u
                          ? await t(a, r.pan, h.pan, c)
                          : await n(a, r.pan, h.pan, c),
                        H(h)
                          ? await i(r, a, h.inputs[0], c)
                          : await i(r, a, h, c),
                        h
                      );
                    })(r, a, c);
        ...
        yn = fn
          ? (
              (t, e, s, n, i, o, r, a, c, h, u, l) =>
              (p, d, f = { credentials: 'omit' }) => {
                const m = o(p);
                if (void 0 !== m.audioWorklet)
                  return Promise.all([i(d), Promise.resolve(t(u, u))]).then(
                    ([[t, e], s]) => {
                      const [n, i] = y(t, e),
                        o = s
                          ? i
                ...
                return (
                  void 0 === v ? c.set(p, new Map([[d, b]])) : v.set(d, b),
                  b
                    .then(() => {
                      const t = h.get(p);
        ...
        wn = ((t, e, s, n, i, o, r, a, c, h, u, l, p, d, f, _, m, g, v, y) =>
          class extends f {
            constructor(e, s) {
              super(e, s),
              ...
              : new Promise((e, s) => {
                  ...
                  try {
                    d.decodeAudioData(
                      p,
                      (s) => {
                        'function' != typeof s.copyFromChannel && (h(s), F(s)),
                          t.add(s),
                          i(),
                          e(s);
                      },
        ...
        Tn = ((t, e, s, n) =>
          ...
          (t, e) => {
            ...
            return (
              It(s, e),
              1 === s.numberOfOutputs &&
                Object.defineProperty(s, 'numberOfOutputs', { get: () => 0 }),
              s
            );
          },
          Fe,
              ...
              if (
                ((this._baseLatency =
                  'number' == typeof e.baseLatency
                    ...
                    ? 1024 / o
                    : (128 *
                        Math.max(2, Math.min(128, Math.round((i * o) / 128)))) /
                      o),
      ...
      const En = (
          ...
          const F = 0 === g.numberOfOutputs ? [D] : M,
            I = {
              ...
              set onprocessorerror(t) {
                'function' == typeof q &&
                  I.removeEventListener('processorerror', q),
                  (q = 'function' == typeof t ? t : null),
                  'function' == typeof q &&
                    I.addEventListener('processorerror', q);
              },
              get parameters() {
                return E;
              },
                  ...
                  const t = W.map((t, e) => {
                      ...
                      return void 0 === n
                        ...
                        : (t.every((t) => t.every((t) => 0 === t)) &&
                            (1 === n ? X.delete(e) : X.set(e, n - 1)),
                          t);
                    }),
                    i = u(d.currentTime + n / d.sampleRate, d.sampleRate, () =>
                      B.process(t, G, U)
                    );
                  Q = i;
                  for (let t = 0, s = 0; t < g.numberOfOutputs; t += 1) {
                    for (let i = 0; i < v[t]; i += 1) _t(e, G[t], i, s + i, n);
                    s += v[t];
                  }
                } catch (t) {
                  (Q = !1),
              ...
              return void 0 !== S
                ...
                : (async (a, w, b) => {
                    let T = u(a),
                      S = null;
                    const k = E(T, w),
                      C = Array.isArray(g.outputChannelCount)
                        ? g.outputChannelCount
                        : Array.from(g.outputChannelCount);
                    if (null === l) {
        ...
        Wn = ((t, e, s, n, i, o, r, a) => {
          ...
          return (h, u) =>
            s(h)
              .render(h, u, c)
              .then(() =>
                Promise.all(Array.from(n(u)).map((t) => s(t).render(t, u, c)))
              )
              .then(() => i(u))
              .then(
                (s) => (
        ...
        Qn = ((Zn = h), (Xn = Ue), (t) => Zn.has(t) || Xn(t));
      var Zn, Xn;
      const Yn = ((Hn = l), ($n = Qe), (t) => Hn.has(t) || $n(t));
      var Hn, $n;
      const Jn = ((t, e) => (s) => {
          const n = t.get(s);
          return e(n) || e(s);
        ...
        Kn = () =>
          (async (t, e, s, n, i, o, r, a, c, h, u, l, p, d, f, _) => {
            if (
              ...
              return (
                await Promise.all([t(n, n), t(r, r), t(f, f), t(_, _)])
              ).every((t) => t);
            }
            return !1;
          })(
      ...
      const mi = 'object' == typeof self ? self : null,
        gi =
          mi &&
          (mi.hasOwnProperty('AudioContext') ||
            mi.hasOwnProperty('webkitAudioContext'));
      function vi(t, e, s, n) {
        var i,
          o = arguments.length,
          r =
        ...
        if (li(t) && li(s))
          for (const e in s)
            Ci(e, s[e])
              ? (t[e] = s[e])
              : li(s[e])
              ? (t[e] || Object.assign(t, { [e]: {} }), Ai(t[e], s[e]))
      ...
      function Di(t, e, s = [], n) {
        ...
        if (li(o[0]) && n && !Reflect.has(o[0], n)) {
          Object.keys(o[0]).some((e) => Reflect.has(t, e)) ||
            (Ai(i, { [n]: o[0] }), s.splice(s.indexOf(n), 1), o.shift());
        }
        if (1 === o.length && li(o[0])) Ai(i, o[0]);
        else for (let t = 0; t < s.length; t++) ci(o[t]) && (i[s[t]] = o[t]);
        return Ai(t, i);
      }
      function Oi(t, e) {
        return ai(t) ? e : t;
       ...
       */ class Ei {
        ...
        log(...t) {
          (this.debug || (mi && this.toString() === mi.TONE_DEBUG_CLASS)) &&
            oi(this, ...t);
        }
        dispose() {
      ...
      class Ni extends Ei {
          ...
          for (; s < i; ) {
            ...
            if (Ii(o[e], t)) {
              for (let s = n; s < this._timeline.length; s++) {
                if (!Ii(this._timeline[s][e], t)) break;
                n = s;
              }
              return n;
            }
            if (Fi(o[e], t) && Ri(r[e], t)) return n;
            Ri(o[e], t) ? (i = n) : (s = n + 1);
          }
          return -1;
        }
        ...
        forEachAtTime(t, e) {
          ...
          if (-1 !== s && Ii(this._timeline[s].time, t)) {
            let n = s;
            for (let e = s; e >= 0 && Ii(this._timeline[e].time, t); e--) n = e;
            this._iterate(
              (t) => {
                e(t);
              },
      ...
      class Gi extends Wi {
        ...
        initialize() {
          ...
          return (
            this._initialized ||
              ((t = this), Pi.forEach((e) => e(t)), (this._initialized = !0)),
            this
          );
        }
        createAnalyser() {
        ...
        addAudioWorkletModule(t, e) {
          return yi(this, void 0, void 0, function* () {
            ti(
              ci(this.rawContext.audioWorklet),
        ...
        close() {
          return yi(this, void 0, void 0, function* () {
            ...
            Si(this._context) && (yield this._context.close()),
              this._initialized && ((t = this), Li.forEach((e) => e(t)));
          });
        }
        getConstant(t) {
      ...
      class Xi extends Ei {
        constructor() {
          ...
          const t = Di(Xi.getDefaults(), arguments, [
            'url',
            'onload',
            'onerror',
          ]);
          (this.reverse = t.reverse),
            ...
            (t.url && ki(t.url)) || t.url instanceof Xi
              ? this.set(t.url)
              : fi(t.url) && this.load(t.url).catch(t.onerror);
        }
        static getDefaults() {
          return { onerror: Zi, onload: Zi, reverse: !1 };
        }
        get sampleRate() {
        ...
        toMono(t) {
          if (ui(t)) this.fromArray(this.toArray(t));
          else {
        ...
        toArray(t) {
          if (ui(t)) return this.getChannelData(t);
        ...
        static load(t) {
          return yi(this, void 0, void 0, function* () {
            ...
            const s =
                '' === Xi.baseUrl || Xi.baseUrl.endsWith('/')
                  ? Xi.baseUrl
                  : Xi.baseUrl + '/',
              n = yield fetch(s + t);
      ...
      class co extends Ei {
        ...
        valueOf() {
          if (
            (this._val instanceof co && this.fromType(this._val), ai(this._val))
          )
            return this._noArg();
          ...
          return (
            Object.keys(t).forEach((e) => {
              if (Reflect.has(this, e)) {
                const s = this[e];
                ci(s) && ci(s.value) && ci(s.setValueAtTime)
                  ? (t[e] = s.value)
                  : s instanceof vo
        ...
        set(t) {
          return (
            Object.keys(t).forEach((e) => {
              Reflect.has(this, e) &&
                ci(this[e]) &&
                (this[e] && ci(this[e].value) && ci(this[e].setValueAtTime)
                  ? this[e].value !== t[e] && (this[e].value = t[e])
                  : this[e] instanceof vo
                  ? this[e].set(t[e])
                  : (this[e] = t[e]));
            }),
            this
      ...
      class xo extends vo {
        constructor() {
          ...
          const t = Di(xo.getDefaults(), arguments, [
            'param',
            'units',
            'convert',
          ]);
          for (
            ti(
              ci(t.param) && (wi(t.param) || t.param instanceof xo),
            ...
            if (null === s) i = n.value;
              ...
              i =
                'linearRampToValueAtTime' === s.type
                  ...
                  : this._exponentialInterpolate(n.time, t, s.time, s.value, e);
            } else i = n.value;
          else {
        ...
        exponentialRampToValueAtTime(t, e) {
          ...
          (s = Ii(s, 0) ? this._minOutput : s), this._assertRange(s);
      ...
      class wo extends vo {
        ...
        get numberOfInputs() {
          return ci(this.input)
            ? wi(this.input) || this.input instanceof xo
              ? 1
        ...
        toMaster() {
          return (
            ri('toMaster() has been renamed toDestination()'),
            this.toDestination()
          );
        }
        disconnect(t, e = 0, s = 0) {
          return So(this, t, e, s), this;
        }
        chain(...t) {
          return bo(this, ...t), this;
        }
        fan(...t) {
        ...
        dispose() {
          return (
            super.dispose(),
            ci(this.input) &&
              (this.input instanceof wo
                ? this.input.dispose()
                : bi(this.input) && this.input.disconnect()),
            ci(this.output) &&
              (this.output instanceof wo
                ? this.output.dispose()
                : bi(this.output) && this.output.disconnect()),
            (this._internalChannels = []),
            this
          );
        }
      ...
      function bo(...t) {
        const e = t.shift();
        t.reduce(
          (t, e) => (t instanceof wo ? t.connect(e) : bi(t) && To(t, e), e),
          e
        );
      }
      function To(t, e, s = 0, n = 0) {
        for (
          ti(ci(t), 'Cannot connect from undefined node'),
            ti(ci(e), 'Cannot connect to undefined node'),
            (e instanceof wo || bi(e)) &&
              ti(e.numberOfInputs > 0, 'Cannot connect to node with no inputs'),
            ti(
              t.numberOfOutputs > 0,
              'Cannot connect from node with no outputs'
            );
          e instanceof wo || e instanceof xo;

        )
          ci(e.input) && (e = e.input);
        for (; t instanceof wo; ) ci(t.output) && (t = t.output);
        wi(e) ? t.connect(e, s) : t.connect(e, s, n);
      }
      function So(t, e, s = 0, n = 0) {
        if (ci(e)) for (; e instanceof wo; ) e = e.input;
        for (; !bi(t); ) ci(t.output) && (t = t.output);
        wi(e)
          ? t.disconnect(e, s)
          : bi(e)
          ? t.disconnect(e, s, n)
      ...
      class Co extends wo {
        constructor(t) {
          super(t),
            ...
            (this._stopTime = -1),
            (this._timeout = -1),
            (this.output = new ko({ context: this.context, gain: 0 })),
        ...
        _onended() {
          if (
            this.onended !== Zi &&
            (this.onended(this), (this.onended = Zi), !this.context.isOffline)
          ) {
      ...
      function Oo(t, e, s, n) {
        (e instanceof xo || wi(e) || (e instanceof Do && e.override)) &&
        ...
        getSecondsAtTime(t) {
          ...
          return (
            this._state.forEachBetween(e.time, t + this.sampleTime, (t) => {
              let e = n.time;
              const s = this._tickOffset.get(t.time);
              s && s.time >= n.time && ((i = s.seconds), (e = s.time)),
                'started' === n.state &&
                  'started' !== t.state &&
                  (i += t.time - e),
                (n = t);
      ...
      class Vo extends Ei {
        ...
        get(t) {
          return (
            ti(this.has(t), 'ToneAudioBuffers has no buffer named: ' + t),
        ...
        add(t, e, s = Zi, n = Zi) {
          return (
              ...
              ? this._buffers.set(t.toString(), new Xi(this.baseUrl + e, s, n))
              : this._buffers.set(t.toString(), new Xi(e, s, n)),
            this
          );
        }
        dispose() {
      ...
      class Go extends wo {
        ...
        static getDefaults() {
          return Object.assign(wo.getDefaults(), { mute: !1, volume: 0 });
        }
        get mute() {
      ...
      class Uo extends wo {
        constructor() {
          super(Di(Uo.getDefaults(), arguments)),
            ...
            (this.input = new Go({ context: this.context })),
            (this.output = new ko({ context: this.context })),
      ...
      class Qo extends Ei {
        constructor(t) {
          super(),
            ...
            (this._timeline = new Ni({ memory: 10 })),
      ...
      class Zo {
        ...
        static getDefaults() {
          return { callback: Zi, once: !1, time: 0 };
        }
        invoke(t) {
          this.callback &&
        ...
        _createEvents(t) {
          ...
          e >= this.time &&
            ...
            (this._nextId = this.transport.scheduleOnce(
              ...
              new jo(this.context, this._nextTick).toSeconds()
            )));
        }
        _restart(t) {
      ...
      class Yo extends vo {
        ...
        _processTick(t, e) {
          if (
            ...
            t +=
              new jo(this.context, (2 * this._swingTicks) / 3).toSeconds() * n;
          }
        ...
        _bindClockEvents() {
          this._clock.on('start', (t, e) => {
            (e = new jo(this.context, e).toSeconds()), this.emit('start', t, e);
          }),
        ...
        start(t, e) {
          let s;
          return ci(e) && (s = this.toTicks(e)), this._clock.start(t, s), this;
        }
        stop(t) {
        ...
        set timeSignature(t) {
          di(t) && (t = (t[0] / t[1]) * 4), (this._timeSignature = t);
        }
        get loopStart() {
          ...
          if (this._clock.ticks !== t) {
            ...
            if ('started' === this.state) {
              const s = this._clock.getTicksAtTime(e),
                n =
                  e +
                  this._clock.frequency.getDurationOfTicks(Math.ceil(s) - s, e);
              this.emit('stop', n),
      ...
      class Ho extends wo {
        ...
        start(t, e, s) {
          ...
          if (
            ...
            if (
              ...
              t &&
                ((t.offset = this.toSeconds(Oi(e, 0))),
            ...
            } else si(this.context), this._start(n, e, s);
          else
            ti(
              Ri(n, this._state.get(n).time),
        ...
        stop(t) {
          ...
          if (
            ...
            'started' === this._state.getValueAtTime(e) ||
              ci(this._state.getNextState('started', e)))
          ) {
      ...
      class Jo extends Ho {
        ...
        set type(t) {
          if (
            (ti(t in tr, 'Noise: invalid type: ' + t),
      ...
      const Ko = { brown: null, pink: null, white: null },
        tr = {
          get brown() {
            if (!Ko.brown) {
              const t = [];
      ...
      class er extends wo {
        constructor() {
          ...
          (this._volume = this.output =
            new Go({ context: this.context, volume: t.volume })),
            (this.volume = this._volume.volume),
            Ui(this, 'volume'),
            (this.mute = t.mute);
        }
        ...
        open(t) {
          return yi(this, void 0, void 0, function* () {
            ...
            if (!this._stream) {
              ...
              To(t, this.output), (this._mediaStream = t);
            }
            return this;
          });
        }
        ...
        static get supported() {
          return (
            ...
            ci(navigator.mediaDevices.getUserMedia)
          );
        }
      }
      function sr(t, e) {
        return yi(this, void 0, void 0, function* () {
          ...
          new t.constructor(
            Object.assign(t.get(), { frequency: 2 / s, detune: 0, context: n })
          )
            .toDestination()
            .start(0);
      ...
      class ir extends Ho {
        ...
        _getCachedPeriodicWave() {
          ...
          {
            const t = ir._periodicWaveCache.find(
          ...
          if (0 === this._phase && e)
            ...
            if (ci(e)) {
              ...
              (this._wave = n),
                ...
                ir._periodicWaveCache.length > 100 &&
                  ir._periodicWaveCache.shift();
            }
          }
        }
        get baseType() {
      ...
      class rr extends or {
        constructor() {
          super(
            Object.assign(
              Di(rr.getDefaults(), arguments, ['mapping', 'length'])
            )
          ),
          ...
          di(t.mapping) || t.mapping instanceof Float32Array
            ? (this.curve = Float32Array.from(t.mapping))
            : hi(t.mapping) && this.setMap(t.mapping, t.length);
        }
        static getDefaults() {
      ...
      class hr extends Ho {
        constructor() {
          super(
            ...
            (this._modulationScale = new ar({ context: this.context })),
            (this._modulationNode = new ko({ context: this.context }));
      ...
      class ur extends Ho {
        constructor() {
          super(
            ...
            (this._modulationNode = new ko({ context: this.context, gain: 0 }));
      ...
      class lr extends Ho {
        constructor() {
          super(Di(lr.getDefaults(), arguments, ['frequency', 'width'])),
            ...
            (this._widthGate = new ko({ context: this.context, gain: 0 })),
            (this._thresh = new rr({
              context: this.context,
              mapping: (t) => (t <= 0 ? -1 : 1),
            }));
      ...
      class pr extends Ho {
        constructor() {
          super(
            Di(pr.getDefaults(), arguments, ['frequency', 'type', 'spread'])
          ),
            (this.name = 'FatOscillator'),
            (this._oscillators = []);
          const t = Di(pr.getDefaults(), arguments, [
            'frequency',
            'type',
            'spread',
          ]);
        ...
        set count(t) {
          if ((ei(t, 1), this._oscillators.length !== t)) {
      ...
      class dr extends Ho {
        constructor() {
          super(
            ...
            (this.sourceType = 'pwm'),
            (this._scale = new cr({ context: this.context, value: 2 }));
          const t = Di(dr.getDefaults(), arguments, [
            'frequency',
            'modulationFrequency',
          ]);
          (this._pulse = new lr({
      ...
      class mr extends Do {
        constructor() {
          super(Object.assign(Di(mr.getDefaults(), arguments, ['value']))),
            (this.override = !1),
            (this.name = 'Add'),
            (this._sum = new ko({ context: this.context })),
      ...
      class gr extends or {
        constructor() {
          ...
          (this._mult = this.input =
            new cr({ context: this.context, value: t.max - t.min })),
            (this._add = this.output =
              new mr({ context: this.context, value: t.min })),
            (this._min = t.min),
            (this._max = t.max),
      ...
      class vr extends or {
        constructor() {
          super(Object.assign(Di(vr.getDefaults(), arguments))),
            (this.name = 'Zero'),
            (this._gain = new ko({ context: this.context })),
        ...
        dispose() {
          return (
            super.dispose(), So(this.context.getConstant(0), this._gain), this
          );
        }
      }
      class yr extends wo {
        constructor() {
          ...
          (this._oscillator = new ir(t)),
            ...
            (this._a2g = new ar({ context: this.context })),
            (this._scaler = this.output =
              new gr({ context: this.context, max: t.max, min: t.min })),
            (this.units = t.units),
            (this.min = t.min),
            (this.max = t.max),
        ...
        connect(t, e, s) {
          return (
            (t instanceof xo || t instanceof Do) &&
      ...
      function wr(t, e = 1 / 0) {
        ...
        return function (n, i) {
          Reflect.defineProperty(n, i, {
            ...
            set: function (n) {
              ei(this.toSeconds(n), t, e), s.set(this, n);
            },
          });
        };
      }
      class br extends Ho {
        ...
        set loopStart(t) {
          (this._loopStart = t),
            this.buffer.loaded &&
              ei(this.toSeconds(t), 0, this.buffer.duration),
      ...
      class Sr extends Ho {
        ...
        _start(t, e, s) {
          (e = Oi(e, 0)), (e = this.toSeconds(e)), (t = this.toSeconds(t));
      ...
      class Ar extends or {
        constructor() {
          super(...arguments),
            (this.name = 'Negate'),
            (this._multiply = new cr({ context: this.context, value: -1 })),
      ...
      class Dr extends Do {
        constructor() {
          super(Object.assign(Di(Dr.getDefaults(), arguments, ['value']))),
            ...
            (this.input = this._sum),
            (this.output = this._sum),
            (this._neg = new Ar({ context: this.context })),
        ...
        constructor() {
          super(Object.assign(Di(Or.getDefaults(), arguments))),
            ...
            (this._scale = this.input =
              new cr({ context: this.context, value: 1e4 })),
      ...
      class Mr extends Do {
        constructor() {
          ...
          (this._subtract = this.input =
            new Dr({ context: this.context, value: t.value })),
            (this._gtz = this.output = new Or({ context: this.context })),
      ...
      class Rr extends gr {
        constructor() {
          super(
            Object.assign(
              Di(Rr.getDefaults(), arguments, ['min', 'max', 'exponent'])
            )
          ),
            (this.name = 'ScaleExp');
          const t = Di(Rr.getDefaults(), arguments, ['min', 'max', 'exponent']);
          (this.input = this._exp =
            new Er({ context: this.context, value: t.exponent })),
      ...
      class qr extends Do {
        ...
        setValueCurveAtTime(t, e, s, n) {
          ...
          return (
            (s = this.toSeconds(s)), super.setValueCurveAtTime(t, i, s, n), this
          );
        }
        cancelAndHoldAtTime(t) {
          const e = new mo(this.context, t).toSeconds();
      ...
      class Fr extends wo {
        constructor() {
          super(
            ...
            (this.name = 'Envelope'),
            (this._sig = new Do({ context: this.context, value: 0 })),
            (this.output = this._sig),
            (this.input = void 0);
          const t = Di(Fr.getDefaults(), arguments, [
            'attack',
            'decay',
            'sustain',
            'release',
        ...
        _getCurve(t, e) {
          ...
          {
            let s;
            for (s in Ir) if (Ir[s][e] === t) return s;
            return t;
          }
        }
        _setCurve(t, e, s) {
      ...
      class Pr extends Fr {
        constructor() {
          super(
            ...
            (this._gainNode = new ko({ context: this.context, gain: 0 })),
            (this.output = this._gainNode),
            (this.input = this._gainNode),
        ...
        static getDefaults() {
          return Object.assign(Nr.getDefaults(), {
            envelope: Object.assign(
              Mi(Fr.getDefaults(), Object.keys(wo.getDefaults())),
      ...
      class Wr extends wo {
        constructor() {
          super(
            Di(Wr.getDefaults(), arguments, ['frequency', 'type', 'rolloff'])
          ),
            (this.name = 'Filter'),
            (this.input = new ko({ context: this.context })),
            (this.output = new ko({ context: this.context })),
            (this._filters = []);
          const t = Di(Wr.getDefaults(), arguments, [
            'frequency',
            'type',
            'rolloff',
          ]);
        ...
        set rolloff(t) {
          ...
          for (let t = 0; t < n; t++) {
            const e = new Br({ context: this.context });
            (e.type = this._type),
      ...
      class Gr extends Fr {
        constructor() {
          ...
          const t = Di(Gr.getDefaults(), arguments, [
            'attack',
            'decay',
            'sustain',
            'release',
        ...
        static getDefaults() {
          return Object.assign(Nr.getDefaults(), {
            ...
            filter: Object.assign(
              Mi(Wr.getDefaults(), Object.keys(wo.getDefaults())),
              { Q: 1, rolloff: -12, type: 'lowpass' }
            ),
            filterEnvelope: Object.assign(
              Mi(Gr.getDefaults(), Object.keys(wo.getDefaults())),
              {
                attack: 0.6,
                baseFrequency: 200,
                decay: 0.2,
            ...
            oscillator: Object.assign(
              Mi(_r.getDefaults(), Object.keys(Ho.getDefaults())),
              { type: 'sawtooth' }
            ),
          });
        }
      ...
      class Yr extends Nr {
        constructor() {
          ...
          for (let e = 0; e < Xr.length; e++) {
            ...
            const n = new cr({ context: this.context, value: Xr[e] });
      ...
      class $r extends Vr {
        ...
        static getDefaults() {
          return Object.assign(Vr.getDefaults(), {
            ...
            noise: Object.assign(
              Mi(Jo.getDefaults(), Object.keys(Ho.getDefaults())),
              { type: 'white' }
            ),
          });
        }
      ...
      class ia extends wo {
        constructor() {
          ...
          const t = Di(ia.getDefaults(), arguments, [
            'delayTime',
            'resonance',
            'dampening',
          ]);
      ...
      class oa extends Vr {
        constructor() {
          ...
          (this._noise = new Jo({ context: this.context, type: 'pink' })),
      ...
      class ra extends Vr {
        ...
        triggerAttackRelease(t, e, s, n) {
          const i = this.toSeconds(s);
          if ((this.triggerAttack(t, i, n), di(e))) {
            ti(
              di(t),
        ...
        set(t) {
          ...
          return (
            (this.options = Ai(this.options, e)),
      ...
      class aa extends Vr {
        constructor() {
          ...
          Object.keys(t.urls).forEach((s) => {
            ...
            if (
              ...
              e[n] = t.urls[s];
            } else ui(n) && isFinite(n) && (e[n] = t.urls[n]);
          }),
            (this._buffers = new Vo({
              urls: e,
              onload: t.onload,
        ...
        triggerAttackRelease(t, e, s, n = 1) {
          ...
          return (
            ...
            di(e)
              ? (ti(di(t), 'notes must be an array when duration is array'),
                t.forEach((t, s) => {
                  const n = e[Math.min(s, e.length - 1)];
        ...
        add(t, e, s) {
          if (
            (ti(_i(t) || isFinite(t), 'note must be a pitch or midi: ' + t),
            _i(t))
          ) {
            ...
            if ('started' === t.state) {
              ...
              if (!0 === this._loop || (ui(this._loop) && this._loop > 1)) {
                ...
                null !== n && (e = Math.min(e, n.time - s)),
                  e !== 1 / 0 &&
                    (this._state.setStateAtTime('stopped', s + e + 1, {
                      id: -1,
                    }),
            ...
            this._loop
              ? t.startOffset >= this._loopStart &&
                ...
                ? (t.startOffset < s && (e += this._getLoopDuration()),
                  t.start(new jo(this.context, e)))
                : t.startOffset < this._loopStart &&
                  t.startOffset >= s &&
                  ((t.loop = !1), t.start(new jo(this.context, e)))
              : t.startOffset >= s && t.start(new jo(this.context, e));
        }
        get startOffset() {
          return this._startOffset;
        }
        ...
        at(t, e) {
          ...
          for (; !o.done; ) {
            ...
            if (Math.abs(s - t.startOffset) < n)
              return ci(e) && (t.value = e), t;
            o = i.next();
          }
          return ci(e) ? (this.add(t, e), this.at(t)) : null;
        }
        add(t, e) {
        ...
        _restartEvent(t) {
          this._state.forEach((e) => {
            'started' === e.state
              ...
              : t.stop(new jo(this.context, e.time));
          });
        }
        remove(t, e) {
          return (
            li(t) && t.hasOwnProperty('time') && (t = (e = t).time),
            (t = this.toTicks(t)),
      ...
      function* la(t) {
        let e = 0;
        for (; e < t.length; ) (e = fa(e, t)), yield t[e], e++;
      }
      function* pa(t) {
        let e = t.length - 1;
        for (; e >= 0; ) (e = fa(e, t)), yield t[e], e--;
      }
      function* da(t, e) {
        for (;;) yield* e(t);
      }
      ...
      function* ma(t) {
        let e = 0,
          s = 0;
        for (; e < t.length; )
          (e = fa(e, t)), yield t[e], s++, (e += s % 2 ? 2 : -1);
      }
      function* ga(t) {
        let e = t.length - 1,
          s = 0;
        for (; e >= 0; ) (e = fa(e, t)), yield t[e], s++, (e += s % 2 ? -2 : 1);
      }
      function* va(t) {
        const e = [];
      ...
      function* ya(t, e = 'up', s = 0) {
        switch (
          (ti(t.length > 0, 'The array must have more than one value in it'), e)
        ) {
          case 'up':
            yield* da(t, la);
          case 'down':
      ...
      class xa extends ha {
        constructor() {
          super(
            Di(xa.getDefaults(), arguments, ['callback', 'values', 'pattern'])
          ),
            (this.name = 'Pattern');
          const t = Di(xa.getDefaults(), arguments, [
            'callback',
            'values',
            'pattern',
          ]);
        ...
        set pattern(t) {
          (this._type = t), (this._pattern = ya(this._values, this._type));
        }
      }
      class wa extends ca {
        constructor() {
          super(
            Di(wa.getDefaults(), arguments, [
              'callback',
              'events',
              'subdivision',
            ])
            ...
            (this._events = []),
            (this._eventsArray = []);
          const t = Di(wa.getDefaults(), arguments, [
            'callback',
            'events',
            'subdivision',
          ]);
        ...
        _createSequence(t) {
          return new Proxy(t, {
            get: (t, e) => t[e],
            set: (t, e, s) => (
              fi(e) && isFinite(parseInt(e, 10)) && di(s)
        ...
        _rescheduleSequence(t, e, s) {
          t.forEach((t, n) => {
            const i = n * e + s;
            if (di(t)) this._rescheduleSequence(t, e / t.length, i);
            else {
      ...
      class ba extends wo {
        constructor() {
          super(Object.assign(Di(ba.getDefaults(), arguments, ['fade']))),
            ...
            (this._g2a = new Cr({ context: this.context })),
            (this.a = new ko({ context: this.context, gain: 0 })),
            (this.b = new ko({ context: this.context, gain: 0 })),
            (this.output = new ko({ context: this.context })),
      ...
      class Ta extends wo {
        constructor(t) {
          super(t),
            (this.name = 'Effect'),
            (this._dryWet = new ba({ context: this.context })),
            (this.wet = this._dryWet.fade),
            (this.effectSend = new ko({ context: this.context })),
            (this.effectReturn = new ko({ context: this.context })),
            (this.input = new ko({ context: this.context })),
      ...
      class ka extends Sa {
        constructor() {
          ...
          const t = Di(ka.getDefaults(), arguments, [
            'frequency',
            'baseFrequency',
            'octaves',
          ]);
      ...
      class Da extends wo {
        constructor() {
          ...
          (this._abs = this.input = new kr({ context: this.context })),
      ...
      class Oa extends Ta {
        constructor() {
          ...
          (this._follower = new Da({
            ...
            (this._baseFrequency = this.toFrequency(t.baseFrequency)),
            (this._octaves = t.octaves),
            (this._inputBoost = new ko({ context: this.context })),
      ...
      class Ra extends Ta {
        constructor() {
          ...
          (this._shaper = new rr({ context: this.context, length: 4096 })),
            (this._order = t.order),
        ...
        constructor(t) {
          super(t),
            ...
            (this._dryWet = this.output =
              new ba({ context: this.context, fade: t.wet })),
            (this.wet = this._dryWet.fade),
            (this._split = new qa({ context: this.context, channels: 2 })),
            (this._merge = new Fa({ context: this.context, channels: 2 })),
      ...
      class Va extends Ia {
        constructor(t) {
          super(t),
            ...
            (this._feedbackL = new ko({ context: this.context })),
            (this._feedbackR = new ko({ context: this.context })),
      ...
      class Na extends Va {
        constructor() {
          super(
            Di(Na.getDefaults(), arguments, ['frequency', 'delayTime', 'depth'])
          ),
            (this.name = 'Chorus');
          const t = Di(Na.getDefaults(), arguments, [
            'frequency',
            'delayTime',
            'depth',
          ]);
          (this._depth = t.depth),
            ...
            (this._delayNodeL = new Fo({ context: this.context })),
            (this._delayNodeR = new Fo({ context: this.context })),
      ...
      class za extends wo {
        constructor(t) {
          super(t),
            ...
            (this.input = new ko({ context: this.context })),
            (this.output = new ko({ context: this.context })),
            (this.offset90 = new ko({ context: this.context }));
      ...
      class Ba extends Ta {
        constructor() {
          ...
          (this.frequency = new Do({
            ...
            (this._sine = new nr({ context: this.context, type: 'sine' })),
            (this._cosine = new ir({
              context: this.context,
              phase: -90,
              type: 'sine',
            })),
            (this._sineMultiply = new cr({ context: this.context })),
            (this._cosineMultiply = new cr({ context: this.context })),
            (this._negate = new Ar({ context: this.context })),
            (this._add = new mr({ context: this.context })),
            (this._phaseShifter = new za({ context: this.context })),
      ...
      const Qa = [0.06748, 0.06404, 0.08212, 0.09004],
        Za = [0.773, 0.802, 0.753, 0.733],
        Xa = [347, 113, 37];
      class Ya extends Ia {
        constructor() {
          ...
          (this.roomSize = new Do({
            ...
            (this._feedbackCombFilters = Qa.map((t, e) => {
              const s = new sa({ context: this.context, delayTime: t });
              return (
      ...
      class Ja extends ja {
        constructor() {
          ...
          (this._frequency = new Do({ context: this.context })),
            (this._delayA = new Fo({ maxDelay: 1, context: this.context })),
            (this._lfoA = new yr({
              context: this.context,
              min: 0,
              max: 0.1,
            ...
            (this._delayB = new Fo({ maxDelay: 1, context: this.context })),
            (this._lfoB = new yr({
              context: this.context,
              min: 0,
              max: 0.1,
            ...
            (this._crossFade = new ba({ context: this.context })),
      ...
      class tc extends Ta {
        ...
        set preDelay(t) {
          ei((t = this.toSeconds(t)), 0), (this._preDelay = t), this.generate();
        }
        generate() {
          return yi(this, void 0, void 0, function* () {
            const t = this.ready,
            ...
            const o = new ko({ context: e }).toDestination();
            i.connect(o),
              s.start(0),
              n.start(0),
        ...
        constructor() {
          super(Di(ec.getDefaults(), arguments)),
            ...
            (this._split = this.input =
              new qa({ channels: 2, context: this.context })),
            (this._midAdd = new mr({ context: this.context })),
            (this.mid = new cr({ context: this.context, value: Math.SQRT1_2 })),
            (this._sideSubtract = new Dr({ context: this.context })),
            (this.side = new cr({
              context: this.context,
              value: Math.SQRT1_2,
            })),
      ...
      class sc extends wo {
        constructor() {
          super(Di(sc.getDefaults(), arguments)),
            ...
            (this.mid = new ko({ context: this.context })),
            (this.side = new ko({ context: this.context })),
            (this._left = new mr({ context: this.context })),
            (this._leftMult = new cr({
              context: this.context,
              value: Math.SQRT1_2,
            })),
            (this._right = new Dr({ context: this.context })),
            (this._rightMult = new cr({
              context: this.context,
              value: Math.SQRT1_2,
            })),
            (this._merge = this.output = new Fa({ context: this.context })),
      ...
      class nc extends Ta {
        constructor(t) {
          super(t),
            ...
            (this._midSideMerge = new sc({ context: this.context })),
            (this._midSideSplit = new ec({ context: this.context })),
      ...
      class ic extends nc {
        constructor() {
          ...
          (this.width = new Do({
            ...
            (this._midMult = new cr({ context: this.context })),
            this._twoTimesWidthMid.connect(this._midMult.factor),
            this.connectEffectMid(this._midMult),
            (this._oneMinusWidth = new Dr({ context: this.context })),
            this._oneMinusWidth.connect(this._twoTimesWidthMid),
            To(this.context.getConstant(1), this._oneMinusWidth),
            this.width.connect(this._oneMinusWidth.subtrahend),
            (this._sideMult = new cr({ context: this.context })),
      ...
      class oc extends Ia {
        constructor() {
          ...
          (this._lfoL = new yr({
            ...
            (this._amplitudeL = new ko({ context: this.context })),
            (this._amplitudeR = new ko({ context: this.context })),
            (this.frequency = new Do({
              context: this.context,
              value: t.frequency,
              units: 'frequency',
        ...
        constructor() {
          super(Di(cc.getDefaults(), arguments)),
            ...
            (this.input =
              this.output =
              this._analyser =
                new ac({ context: this.context, size: 256, type: 'waveform' }));
        }
        dispose() {
      ...
      class hc extends cc {
        ...
        getLevel() {
          return (
            ri("'getLevel' has been changed to 'getValue'"), this.getValue()
          );
        }
        getValue() {
          const t = this._analyser.getValue(),
            e = (1 === this.channels ? [t] : t).map((t) => {
              ...
              return (
                (this._rms = Math.max(s, this._rms * this.smoothing)),
      ...
      class dc extends wo {
        constructor() {
          ...
          (this.input = this.output = new ko({ context: this.context })),
            dc._allSolos.has(this.context) ||
              dc._allSolos.set(this.context, new Set()),
            dc._allSolos.get(this.context).add(this),
            (this.solo = t.solo);
        }
        static getDefaults() {
          return Object.assign(wo.getDefaults(), { solo: !1 });
        }
        get solo() {
        ...
        _addSolo() {
          dc._soloed.has(this.context) ||
            dc._soloed.set(this.context, new Set()),
            dc._soloed.get(this.context).add(this);
        }
        _removeSolo() {
          dc._soloed.has(this.context) &&
            dc._soloed.get(this.context).delete(this);
        }
        _isSoloed() {
          return (
            dc._soloed.has(this.context) &&
            dc._soloed.get(this.context).has(this)
          );
        }
        _noSolos() {
          return (
            !dc._soloed.has(this.context) ||
            (dc._soloed.has(this.context) &&
              0 === dc._soloed.get(this.context).size)
          );
        }
        _updateSolo() {
      ...
      class _c extends wo {
        constructor() {
          ...
          (this._solo = this.input =
            new dc({ solo: t.solo, context: this.context })),
        ...
        _getBus(t) {
          return (
            _c.buses.has(t) ||
              _c.buses.set(t, new ko({ context: this.context })),
            _c.buses.get(t)
          );
        }
        send(t, e = 0) {
          const s = this._getBus(t),
            n = new ko({ context: this.context, units: 'decibels', gain: e });
        ...
        constructor() {
          super(Di(mc.getDefaults(), arguments)),
            ...
            (this._merge = this.output =
              new Fa({ channels: 2, context: this.context })),
      ...
      class gc extends wo {
        constructor() {
          super(
            Di(gc.getDefaults(), arguments, ['lowFrequency', 'highFrequency'])
          ),
          ...
          const t = Di(gc.getDefaults(), arguments, [
            'lowFrequency',
            'highFrequency',
          ]);
      ...
      class yc extends wo {
        constructor() {
          super(
            ...
            (this.name = 'Panner3D');
          const t = Di(yc.getDefaults(), arguments, [
            'positionX',
            'positionY',
            'positionZ',
          ]);
      ...
      class xc extends wo {
        ...
        pause() {
          return (
            ti('started' === this.state, 'Recorder must be started'),
      ...
      class bc extends wo {
        constructor() {
          super(
            Object.assign(
              Di(bc.getDefaults(), arguments, ['threshold', 'smoothing'])
            )
          ),
            (this.name = 'Gate');
          ...
          (this._follower = new Da({
            ...
            (this.input = new ko({ context: this.context })),
            (this._gate = this.output = new ko({ context: this.context })),
      ...
      class Sc extends wo {
        constructor() {
          ...
          (this._midSideSplit = this.input = new ec({ context: this.context })),
            (this._midSideMerge = this.output =
              new sc({ context: this.context })),
            (this.mid = new wc(
      ...
      class Ac extends wo {
        ...
        static getDefaults() {
          return Object.assign(wo.getDefaults(), { normalize: !0, onload: Zi });
        }
        load(t) {
          return yi(this, void 0, void 0, function* () {
